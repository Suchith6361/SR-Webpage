...
const Assets = () => {
  return (
    <div>
      <section className="flex flex-col lg:flex-row items-center justify-center h-autopx-4 lg:px-24">
        ...
        <div className="w-full lg:w-1/2 lg:pl-12">
          ...
          <p className="text-gray-400 text-lg lg:text-sm mb-6">
            Kickstart your business with thousands of ready-to-use design
            assets.
          </p>

          <ul className="grid grid-cols-1 sm:grid-cols-2 text-[10px] gap-4 text-gray-700">
          ...
          <button className="mt-4 px-4 text-[12px] font-semibold py-1 bg-blue-200 text-gray-800 rounded-full hover:bg-blue-600 transition duration-300">
            See example assets
          </button>
        </div>
      </section>
